...
/// <summary>
/// Giant state machine: Roaming → Hunting → Attacking → Dead.
/// Huge slow enemy targeting bumpkins and cows.
/// Sprites: gianstil (still), giant (walk), gianatt (attack), giandead (dead).
/// </summary>
